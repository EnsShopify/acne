...
(function (bodyScrollLock, themeCurrency, themeImages, themeAddresses, Sqrl, Flickity, FlickityFade, Rellax, ellipsed, AOS) {
    ...
    (window.theme = window.theme || {}),
        ...
        (window.theme.keyboardKeys = { TAB: 9, ENTER: 13, ESCAPE: 27, SPACE: 32, LEFTARROW: 37, RIGHTARROW: 39 }),
    ...
    function lock(e) {
        bodyScrollLock.disableBodyScroll(e.detail, { allowTouchMove: (e) => "TEXTAREA" === e.tagName }), document.documentElement.setAttribute("data-scroll-locked", "");
    }
    function unlock() {
        if (
            ...
            return document.body.removeAttribute("data-drawer-closing"), void (scrollLockTimeout && clearTimeout(scrollLockTimeout));
        document.body.setAttribute("data-drawer-closing", ""), document.documentElement.removeAttribute("data-scroll-locked"), bodyScrollLock.clearAllBodyScrollLocks();
    }
    ...
    document.addEventListener("touchstart", wasTouched, { passive: !0 }),
        ...
        window.addEventListener("load", () => {
            setVarsOnResize(), floatLabels(document), preventOverflow(document), wrapElements(document);
        }),
        document.addEventListener("shopify:section:load", (e) => {
            const t = e.target;
            floatLabels(t), preventOverflow(t), wrapElements(t), ariaToggle(document);
        }),
        (function () {
            function e(e) {
            ...
            window.visibilityHelper = {
                ...
                inViewportPartially: function (e, s) {
                    ...
                    var o = t(e);
                    window.addEventListener("load", i), window.addEventListener("resize", i), window.addEventListener("scroll", i);
                },
    ...
    Shopify.Products = (function () {
        const e = { howManyToShow: 4, howManyToStoreInMemory: 10, wrapperId: "recently-viewed-products", templateId: "recently-viewed-product-template", section: null, onComplete: null };
        let t = [],
            s = null,
            i = null,
            o = null;
                          ...
                          .then((e) => {
                              ...
                              for (let t = 0; t < e.tags.length; t++) {
                                  if (e.tags[t].includes("_badge_")) {
                                      (r = !0), (o = e.tags[t].replace("_badge_", "").split("_").join(" "));
                                      break;
                                  }
                              ...
                              r && (u = ""),
                                  c && !r && (p = ""),
                                  e.compare_at_price > e.price && ((y = "sale"), (m = ""), (c && r) || ((g = ""), (m = "is-hidden hidden"))),
                                  e.available || ((p = "is-hidden hidden"), (y = "is-hidden hidden"), (b = "")),
                                  e.price_varies && (f = "");
                              ...
                              (E = E.replace(/\|\|itemUrl\|\|/g, e.url)),
                                  ...
                                  (E =
                                      "Title" === e.options[0].name && 1 === e.options.length && "Default Title" === e.options[0].values[0]
                                          ? E.replace(/\|\|itemHasOnlyDefault\|\|/g, "data-quick-add-button")
                                          : E.replace(/\|\|itemHasOnlyDefault\|\|/g, ""));
                              ...
                              (E = E.replace(/\|\|itemSwatchesHidden\|\|/g, L.length > 0 ? "" : "hide")), (E = E.replace(/\|\|itemColorLabel\|\|/g, L.length > 0 ? L[0].name : "")), (n.innerHTML += E), s.shift(), t++, a(t, s, n, l);
                          })
                          .catch(() => {
                              r.remove(s[0]), s.shift(), a(t, s, n, l);
                          })
                    : ((t, s) => {
                          showElement(t, !0);
                          ...
                          if (Shopify.recentlyViewed && o && i && i < o && t.children.length) {
                              ...
                              for (const t in Shopify.recentlyViewed) {
                                  ...
                                  (e = [...e, ...o]), (r.read().length === a || (i === Object.keys(Shopify.recentlyViewed).length && !s.length)) && (s = [...s, ...o]);
                              }
            ...
            recordRecentlyViewed: function (t) {
                ...
                if (-1 !== window.location.pathname.indexOf("/products/")) {
                    const t = decodeURIComponent(window.location.pathname)
                            ...
                            .split("/products/")[1],
                        s = i.indexOf(t);
                    -1 === s ? (i.unshift(t), (i = i.splice(0, e.howManyToStoreInMemory))) : (i.splice(s, 1), i.unshift(t)), r.write(i);
                }
            },
        ...
        fadeIn = (e, t, s = null) => {
            (e.style.opacity = 0),
                ...
                (function t() {
                    ...
                    (i += 0.1) > 1 || ((e.style.opacity = i), requestAnimationFrame(t)), 1 === i && "function" == typeof s && s();
                })();
        };
        ...
        (Shopify.Cart.ShippingCalculator = (function () {
            const _config = {
                ...
                _onCartShippingRatesUpdate = function (e, t) {
                    ...
                    e.length && i && ("0.00" == e[0].price ? (i.textContent = "FREE") : (i.textContent = themeCurrency.formatMoney(e[0].price, theme.moneyFormat))), _render({ rates: e, address: s, success: !0 });
    ...
    function trapFocus(e, t) {
        ...
        removeTrapFocus(),
            (trapFocusHandlers.focusin = function (t) {
                e === t.target || e.contains(t.target) || o.focus(), (t.target !== e && t.target !== r && t.target !== o) || document.addEventListener("keydown", trapFocusHandlers.keydown);
            }),
    ...
    function accessibleLinks(e, t) {
        ...
        if (0 !== (e = document.querySelectorAll(e)).length) {
            ...
            var s = { newWindow: t.messages.newWindow || "Opens in a new window.", external: t.messages.external || "Opens external website.", newWindowExternal: t.messages.newWindowExternal || "Opens external website in a new window." },
                i = t.prefix || "a11y",
                o = { newWindow: i + "-new-window-message", external: i + "-external-message", newWindowExternal: i + "-new-window-external-message" };
            e.forEach(function (e) {
                ...
                (function (e) {
                    ...
                    t.setAttribute("hidden", !0), (t.innerHTML = s), document.body.appendChild(t);
                })(s);
        }
    }
    ...
    const slideDown = (e, t = 500, s = !0) => {
            ...
            if (s && "none" !== i) return;
            e.style.removeProperty("display"), "none" === i && (i = "block"), (e.style.display = i);
    ...
    const selectors = { saleClass: "sale", soldClass: "sold-out", doubleImage: "double__image" };
    function formatPrices(e) {
        const t = e.price <= e.compare_at_price_min;
        let s = t ? selectors.saleClass : "";
        if (((s += e.available ? "" : selectors.soldClass), (e.price = themeCurrency.formatMoney(e.price, theme.moneyFormat)), (e.price_with_from = e.price), e.price_varies)) {
    ...
    const selectors$1 = { template: "[pair-product-template]", pairProducts: "[data-pair-products]", upsellButton: "[data-upsell-btn]", upsellButtonText: "[data-upsell-btn-text]" };
    class PairWithProduct {
        ...
        init() {
            if (this.handle.includes("_")) {
                ...
                (this.handle = e[0]), (this.variant = e[1]);
            }
            fetchProduct(this.handle)
                .then((e) => {
                    if (void 0 === e) return void this.document.dispatchEvent(new CustomEvent("upsell-product-error"));
                    const t = formatPrices(e);
                    let s = !1;
                    null !== this.variant && t.variants.filter((e) => (e.id === Number(this.variant) && e.available && ((this.variantObject = e), (s = !0)), e)),
                        (t.available && null === this.variant) || s ? this.renderPairProduct(t) : ((this.pairProducts.innerHTML = ""), this.document.dispatchEvent(new CustomEvent("upsell-unavailable")));
                })
                .catch((e) => {
                    console.error(e);
                });
        ...
        renderPairProduct(e) {
            ...
            (this.pairProducts.innerHTML = t), this.upsellButtonDemensions();
        }
        upsellButtonDemensions() {
            this.calcUpsellButtonDemensions(), document.addEventListener("theme:resize", this.resizeEventUpsell);
        }
        ...
        renderProduct(e) {
            ...
            if (
                ...
                (s = t ? { thumb: themeImages.getSizedImageUrl(t.preview_image.src, "480x480") } : { thumb: window.theme.assets.no_image }),
                ...
                for (let t = 0; t < e.variants.length; t++) {
                    ...
                    if (s.available) {
                        ...
                        i = { ...formatPrices(s), title: e, hasUnitPrice: r };
                        break;
                    }
                }
            if (null !== this.variantObject) {
                ...
                i = { ...formatPrices(this.variantObject), title: e, hasUnitPrice: r };
            }
            if ("" === i) return "";
            const a = e.title.replace(/(<([^>]+)>)/gi, "");
            i.unit_price_measurement && ((i.unitValue = i.unit_price_measurement.reference_unit), 1 !== i.unit_price_measurement.reference_value && (i.unitCount = i.unit_price_measurement.reference_value));
            const n = { ...e, title: a, image: s, firstAvailableVariant: i, hasVariants: o, addToCartText: theme.strings.upsellAddToCart, unitPriceLabel: theme.strings.unitPrice, unitPriceSeparator: theme.strings.unitPriceSeparator };
            return Sqrl.render(this.template, { product: n });
        }
    }
    const selectors$2 = {
    ...
    class QuantityCounter {
        ...
        changeValueOnInput() {
            ...
            this.field.addEventListener(
                "input",
                function () {
                    (e.quantityValue = this.value), "" === this.value && (e.emptyField = !0), e.updateQuantity();
                },
                this
            );
        }
        ...
        disableIncrease() {
          this.increaseButton.classList.toggle(this.settings.isDisabled, this.quantityValue >= 5);
            // this.increaseButton.classList.toggle(this.settings.isDisabled, this.quantityValue >= this.maxValue && null !== this.maxValue);
        }
        updateCart() {
            const e = new CustomEvent("update-cart", { bubbles: !0, detail: { id: this.cartItemID, quantity: this.quantityValue, valueIsEmpty: this.emptyField } });
    ...
    const settings = {
        ...
        attributes: { transparent: "data-header-transparent", upsellButton: "data-upsell-btn" },
        elements: {
            html: "html",
    ...
    class CartDrawer {
        ...
        init() {
            (this.settings = settings),
                ...
                (this.cartSaving = this.document.querySelector('[cartSaving]')),
                (this.cartSavingPrepaid = this.document.querySelector('[cartSavingPrepaid]')),
                        ...
                        e.length > 1 &&
                            e.forEach((e) => {
                                if (e !== i.parentElement) {
                                    ...
                                    t.classList.remove(this.settings.classes.active), slideUp(t.nextElementSibling, 400);
                                }
                            });
                });
            });
        ...
        customEventsHandle(e) {
            e.addEventListener(
                "update-cart",
                debounce((t) => {
                    this.updateCart({ id: t.detail.id, quantity: t.detail.quantity }, e, t.detail.valueIsEmpty);
                }, 500)
            );
        }
        ...
        cartEvents() {
            ...
            this.document.querySelectorAll(e.settings.elements.cartItemRemove).forEach((t) => {
                t.addEventListener("click", function (t) {
                    t.preventDefault(), e.updateCart({ id: this.getAttribute("data-id"), quantity: 0 });
                });
            }),
        ...
        cartEventAdd() {
            this.document.addEventListener("click", (e) => {
                ...
                if (t.matches(this.settings.elements.buttonAddToCart) || (t.closest(this.settings.elements.buttonAddToCart) && t)) {
                    ...
                    if (
                        (i.hasAttribute(this.settings.elements.productIDAttribute)
                            ? (s = `id=${Number(i.getAttribute(this.settings.elements.productIDAttribute))}`)
                            : ((this.form = t.closest("form")), (s = new FormData(this.form)), (s = new URLSearchParams(s).toString())),
                        null !== this.form && this.form.querySelector('[type="file"]'))
                    )
                        return;
                    if ((e.preventDefault(), t.hasAttribute("disabled") || t.parentNode.hasAttribute("disabled"))) return;
                    this.addToCart(s, null, i), this.html.dispatchEvent(new CustomEvent("cart:add-item", { bubbles: !0, detail: { selector: t } }));
                }
            });
        }
            ...
            fetch("/cart.js")
                ...
                .then(
                    (e) => (
                        ...
                        buildCartDrawerFunction(e),
                        this.buildTotalPrice(e),
                        this.freeShippingMessageHandle(e.total_price),
                        this.cartMessage.length > 0 && ((this.subtotal = e.total_price), this.updateProgress()), 
        ...
        addToCart(e, t = null, s = null, i = null) {
            null === this.form && null !== t && t.label && (this.form = t.label.parentNode.querySelector("form")),
                ...
                fetch("/cart/add.js", { method: "POST", headers: { "X-Requested-With": "XMLHttpRequest", "Content-Type": "application/x-www-form-urlencoded" }, body: e })
                    .then((e) => e.json())
                    .then((e) => {
                        s && s.setAttribute("disabled", "disabled"),
                            e.status
                                ...
                                ? (null !== t && t.label && (t.label.classList.remove(this.settings.classes.hidden, this.settings.classes.loading), t.label.classList.add(this.settings.classes.added)),
                                  this.getCart(),
                                  setTimeout(() => {
                                      null !== s &&
                                          ...
                                          document.dispatchEvent(new CustomEvent("product:bar:button", { bubbles: !1 })),
                                          s.closest(this.settings.elements.pairProductsHolder) &&
                                              setTimeout(() => {
                                                  s.classList.remove(this.settings.classes.success);
                                              }, 2 * this.settings.times.timeoutAddProduct)),
                                          this.cartDropdown && (this.openCartDropdown(), (this.cartDropdownIsOpen = !0));
        ...
        updateCart(e = {}, t = null, s = !1) {
          ...
          // $('button.cart__checkout').css('pointer-events','none');
            null !== t && t.closest(this.settings.elements.item).classList.add(this.settings.classes.loading),
                this.items.forEach((e) => {
                    e.classList.add(this.settings.classes.disabled), e.querySelector("input").blur();
                }),
                fetch("/cart.js")
                    .then(this.handleErrors)
                    .then((e) => e.json())
                    .then((t) => {
                        ...
                        const i = { line: `${s + 1}`, quantity: a };
                        return fetch("/cart/change.js", { method: "post", headers: { "Content-Type": "application/json" }, body: JSON.stringify(i) });
                    })
                    .then(this.handleErrors)
                    .then((e) => e.json())
                    .then((e) => {
                        (i = e.item_count),
                            s && (a = 1),
                            0 !== a && ((this.cartLimitErrorIsHidden = i !== o), this.toggleLimitError(r)),
        ...
        toggleLimitError(e) {
            (this.cartErrorHolder.querySelector(this.settings.elements.errorMessage).innerText = e), this.cartLimitErrorIsHidden ? slideUp(this.cartErrorHolder, 400) : slideDown(this.cartErrorHolder, 400);
        }
        handleErrors(e) {
            return e.ok
                ? e
        ...
        addToCartError(e, t, s) {
            ...
            i &&
                ...
                document.dispatchEvent(new CustomEvent("product:bar:error", { bubbles: !1 }))),
                t && this.html.dispatchEvent(new CustomEvent("cart:add-to-error", { bubbles: !0, detail: { message: e.message, description: e.description, holder: t } })),
                this.document.addEventListener("click", (e) => {
                    const t = e.target;
                    (t.matches(this.settings.elements.formCloseError) || t.closest(this.settings.elements.formCloseError)) && (e.preventDefault(), i.classList.remove(this.settings.classes.visible));
                });
        }
        openCartDropdown() {
            document.dispatchEvent(new CustomEvent("theme:drawer:close", { bubbles: !1 })),
                document.dispatchEvent(new CustomEvent("theme:scroll:lock", { bubbles: !0, detail: this.cartDropdown })),
                document.dispatchEvent(new CustomEvent("theme:scroll:lock", { bubbles: !0, detail: this.cartDropdownBody })),
                ...
                this.accessibility.trapFocus(this.cartDropdown, { elementToFocus: this.cartDropdown.querySelector("a:first-child, input:first-child") }),
                this.cartDropdownIsBuilded || this.getCart();
        }
        closeCartDropdown() {
            if ((this.document.dispatchEvent(new CustomEvent("theme:cart-close", { bubbles: !0 })), this.accessibility.removeTrapFocus(), slideUp(this.cartErrorHolder, 400), this.html.classList.contains("is-focused"))) {
        ...
        toggleCartDropdown() {
            (this.cartDropdownIsOpen = !this.cartDropdownIsOpen), this.cartDropdownIsOpen ? this.openCartDropdown() : this.closeCartDropdown();
        }
        eventToggleCart() {
            this.document.addEventListener("click", (e) => {
                const t = e.target,
                ...
                t.matches(this.settings.elements.cartToggleElement) || t.closest(this.settings.elements.cartToggleElement)
                    ? (e.preventDefault(), this.toggleCartDropdown())
                    : this.cartDropdownIsOpen && s && i && o && ((this.cartDropdownIsOpen = !1), this.closeCartDropdown());
            });
        }
        ...
        build(e) {
            this.totalItems !== this.newTotalItems && ((this.totalItems = this.newTotalItems), this.toggleClassesOnContainers()), (this.itemsHolder.innerHTML = e), this.cartEvents(), this.initQuantity();
        }
        updateCounter(e) {
            this.counterHolders.length &&
                this.counterHolders.forEach((t) => {
                    (t.innerHTML = e), t.setAttribute(settings.elements.cartCountValue, e);
                });
        }
        hasItemsInCart() {
        ...
        buildTotalPrice(e) {
            if (
                (e.original_total_price > e.total_price && e.cart_level_discount_applications.length > 0
                    ? (this.cartOriginalTotal.classList.remove(this.settings.classes.hidden), (this.cartOriginaTotalPrice.innerHTML = themeCurrency.formatMoney(e.original_total_price, this.settings.formatMoney)))
                ...
                (this.cartTotal.innerHTML = themeCurrency.formatMoney(e.total_price, this.settings.formatMoney)),
                 this.cartTotal.setAttribute('sub-total',e.total_price),
                 // console.log(">>>this.cartSavingPrepaid ",e.total_discount),
                (this.cartSavingPrepaid.innerHTML = themeCurrency.formatMoney(e.total_discount, this.settings.formatMoney)),
                 (this.cartSaving.innerHTML = themeCurrency.formatMoney(e.total_discount, this.settings.formatMoney)),
                e.cart_level_discount_applications.length > 0)
            ) {
                const t = this.buildCartTotalDiscounts(e.cart_level_discount_applications);
                this.cartDiscountHolder.classList.remove(this.settings.classes.hidden), (this.cartDiscountHolder.innerHTML = t);
            } else this.cartDiscountHolder.classList.add(this.settings.classes.hidden);
        }
        buildCartTotalDiscounts(e) {
            let t = "";
            return (
                e.forEach((e) => {
                    t += Sqrl.render(this.cartTotalDiscountTemplate, { discountTitle: e.title, discountTotalAllocatedAmount: themeCurrency.formatMoney(e.total_allocated_amount, this.settings.formatMoney) });
                }),
                t
            );
        } 
        freeShippingMessageHandle(e) {
            this.cartMessage.length > 0 &&
                this.document.querySelectorAll(this.settings.elements.cartMessage).forEach((t) => {
        ...
        updateProgress() {
          const limit_for_free_shipping = this.cartFreeLimitShipping - this.subtotal;
      ...
      if(limit_for_free_shipping > 0){
      var charge = $('.free__cart__limit').attr('data-charge');
      $('.free__cart__limit').text('₹'+charge);
      }
      else{
      $('.free__cart__limit').text('Free');
      }
        }
        renderPairProducts() {
            null !== this.pairProductsHolder &&
                (void 0 === this.pairWithArray || this.pairWithArray.length <= 0
        ...
        getEnablePairProducts() {
            void 0 !== this.pairWithArray &&
                void 0 !== this.sessionStorage &&
                null !== this.sessionStorage.getItem("pair_products") &&
                (this.pairWithArray = this.pairWithArray.filter((e) => -1 === this.sessionStorage.getItem("pair_products").indexOf(`,${e},`)));
        }
        pairProductSkipEvent() {
            null !== this.pairProductsHolder &&
                this.pairProductsHolder.addEventListener("click", (e) => {
                    const t = e.target;
                    (t.matches(this.settings.elements.buttonSkipPairProduct) || t.closest(this.settings.elements.buttonSkipPairProduct)) &&
                        (e.preventDefault(),
                        void 0 !== this.sessionStorage &&
                            this.sessionStorage.setItem("pair_products", null !== this.sessionStorage.getItem("pair_products") ? `${this.sessionStorage.getItem("pair_products")},${this.pairWithArray[0]},` : `,${this.pairWithArray[0]},`),
                        this.getEnablePairProducts(),
    ...
    const settings$1 = {
        ...
        classes: { focus: "is-focused", open: "is-open", accordionToggle: "accordion-toggle", tabLink: "tab-link" },
    ...
    class Accessibility {
        ...
        focusEvents() {
            this.document.addEventListener("keyup", (e) => {
                e.keyCode === this.settings.keysCodes.tabCode && (this.body.classList.add(this.settings.classes.focus), (this.isFocused = !0));
            }),
                this.document.addEventListener("keyup", (e) => {
                    ...
                    const t = e.target,
                        ...
                        o =
                            ...
                            t.parentNode.classList.contains(this.settings.classes.accordionToggle) ||
                            t.hasAttribute(this.settings.elements.accordionDataToggle) ||
                            t.parentNode.hasAttribute(this.settings.elements.accordionDataToggle),
                    ...
                    if ((a && t.click(), s && i)) {
                        ...
                        if ((n && (e = this.document.querySelector(this.settings.elements.search)), o && ((e = t.nextElementSibling), t.click()), r)) {
                            const s = `.tab-content-${t.getAttribute("data-tab")}`;
                            (e = this.document.querySelector(s)), t.click();
                        }
                        e.querySelector("a, input") && this.a11y.trapFocus(e, { elementToFocus: e.querySelector("a:first-child, input:first-child") });
                    }
                }),
        ...
        closeExpandedElements() {
            document.addEventListener("keyup", (e) => {
                ...
                this.a11y.removeTrapFocus(),
                    this.html.classList.contains(this.cart.settings.classes.htmlClasses) &&
                        (this.cart.toggleCartDropdown(), this.html.classList.remove(this.cart.settings.classes.htmlClasses), this.cartDropdown.classList.remove(this.cart.settings.classes.open));
                const t = document.querySelectorAll(this.settings.elements.accordionContent);
                if (t.length)
                    for (let e = 0; e < t.length; e++) {
                        if ("block" !== t[e].style.display) continue;
                        t[e].previousElementSibling.classList.remove(this.settings.classes.open), slideUp(t[e]);
                    }
        ...
        (theme.ProductModel = (function () {
                ...
                if (e) console.warn(e);
                    ...
                    for (const e in t)
                        if (t.hasOwnProperty(e)) {
                            const s = t[e];
                            s.modelViewerUi || (s.modelViewerUi = new Shopify.ModelViewerUI(s.$element)), m(s);
                        }
            }
            function m(e) {
                const t = s[e.sectionId];
                e.$container.addEventListener("mediaVisible", function () {
                    t.$element.setAttribute(l, e.modelId), g(e.mediaId), window.theme.touched || e.modelViewerUi.play();
                }),
            ...
            function g(e) {
                ...
                s.classList.remove(h),
                    o.length &&
                        o.forEach((e) => {
                            e.dispatchEvent(new CustomEvent("mediaHidden")), e.classList.add(h);
                        });
            }
            return {
                init: function (i, l) {
                    ...
                    (s[l] = { $element: g, defaultId: m }),
                        (t[d] = { modelId: m, mediaId: d, sectionId: l, $container: i, $element: h }),
    ...
    class Addresses {
        constructor(e) {
            (this.section = e), (this.addressNewForm = this.section.querySelector(selectors$3.addressNewForm)), this.init();
        }
        init() {
                ...
                o.length &&
                    o.forEach((e) => {
                        e.addEventListener("click", function () {
                            ...
                            confirm(t || selectors$3.defaultConfirmMessage) && Shopify.postLink("/account/addresses/" + e, { parameters: { _method: "delete" } });
                        });
                    });
            }
        }
        customerAddresses() {
            Shopify.CountryProvinceSelector && new Shopify.CountryProvinceSelector(selectors$3.addressCountryNew, selectors$3.addressProvinceNew, { hideElement: selectors$3.addressProvinceContainerNew });
    ...
    const selectors$4 = { accountTemplateLogged: ".customer-logged-in", account: ".account", accountSidebarMobile: ".account-sidebar--mobile" };
    class Account {
        constructor(e) {
    ...
    const selectors$5 = { form: "[data-account-form]", showReset: "[data-show-reset]", hideReset: "[data-hide-reset]", recover: "[data-recover-password]", login: "[data-login-form]", recoverHash: "#recover", hideClass: "is-hidden" };
    class Login {
        constructor(e) {
            (this.form = e),
        ...
        showRecoverPasswordForm() {
            return this.login.classList.add(selectors$5.hideClass), this.recover.classList.remove(selectors$5.hideClass), (window.location.hash = selectors$5.recoverHash), !1;
        }
        hideRecoverPasswordForm() {
            return this.recover.classList.add(selectors$5.hideClass), this.login.classList.remove(selectors$5.hideClass), (window.location.hash = ""), !1;
        }
    }
    ...
    const registered = window.Shopify.theme.sections.registered,
        ...
        selectors$6 = { id: "data-section-id", type: "data-section-type" };
    class Registration {
    ...
    class Section {
        constructor(e, t) {
            (this.container = validateContainerElement(e)), (this.id = e.getAttribute(selectors$6.id)), (this.type = t.type), (this.callStack = t.getStack());
            try {
                this.onLoad();
            } catch (e) {
    ...
    function validateContainerElement(e) {
        ...
        if (null === e.getAttribute(selectors$6.id)) throw new Error("Theme Sections: The section container provided does not have an id assigned to the " + selectors$6.id + " attribute.");
        return e;
    }
            ...
            e.forEach(function (e) {
                ...
                void 0 !== s &&
                    (t = t.filter(function (t) {
                        return !isInstance(t) && null !== t.getAttribute(selectors$6.type) && (t.getAttribute(selectors$6.type) !== e || (instances.push(new Section(t, s)), !1));
                    }));
            });
    }
    function reorder(e, t) {
        (e = normalizeType(e)), (t = normalizeContainers(t));
        const s = registered[e[0]];
        if (void 0 !== s) return !isInstance(t) && null !== t.getAttribute(selectors$6.type) && (t.getAttribute(selectors$6.type) !== e[0] || (instances.push(new Section(t, s)), !1));
    }
    function unload(e) {
    ...
    class Slider {
        ...
        init() {
            const e = {
                ...
                on: {
                    ready: () => {
                        ...
                        setTimeout(() => {
                            this.slideshow.parentNode.dispatchEvent(new CustomEvent("slider-is-loaded", { bubbles: !0, detail: { slider: this } }));
                        }, 10),
                            this.slideActions(),
                            this.slideshow.classList.contains(classes.classIsSelected) && this.slideshow.classList.remove(classes.classIsSelected),
                            this.showArrows && (this.initArrows(), this.positionArrows());
                    },
                    resize: () => {
            ...
            this.fade && ((e.fade = !0), (this.flkty = new FlickityFade(this.slideshow, e))),
                ...
                this.sliderThumbsClick.length &&
                    this.sliderThumbsClick.forEach((e) => {
        ...
        sliderSettle() {
            ...
            this.sliderAnimateOnce && (e = this.slideshow.querySelectorAll(`.${classes.classIsSelected}:not(.${classes.classAosAnimated}) .${classes.classAosAnimated}`)),
                e.length &&
                    e.forEach((e) => {
                        e.classList.add(classes.classAosAnimate), this.sliderAnimateOnce && e.closest(`.${classes.classIsSelected}`).classList.add(classes.classAosAnimated);
                    });
        }
        addRemoveSlidesForDevices() {
            if (
                ((this.hasDiffSlidesForMobileDesktop =
                    Array.prototype.filter.call(this.slideshowSlides, (e) => {
                        if (e.classList.contains("desktop") || e.classList.contains("mobile")) return e;
                    }).length > 0),
                !this.hasDiffSlidesForMobileDesktop)
            )
                return;
            let e = null;
            (e =
                (window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth) <= 749
                    ? `${selectors$7.slide}.mobile, ${selectors$7.slide}:not(.desktop)`
                    : `${selectors$7.slide}.desktop, ${selectors$7.slide}:not(.mobile)`),
        ...
        resizeEvents() {
            this.setMinHeight(), this.multipleSlides && (this.showArrows && this.initArrows(), this.flkty.resize(), this.slideshow.classList.contains(classes.classSliderInitialized) || this.flkty.select(0));
        }
        slideActions() {
            const e = this.slideshow.querySelector(`.${classes.classIsSelected}`);
            (this.currentSlideColor = e.getAttribute(selectors$7.dataColor)),
                this.currentSlideColor && (this.slideshow.classList.remove(classes.textLight, classes.textDark), this.slideshow.classList.add(this.currentSlideColor)),
                this.container.classList.remove(classes.transparentWrapper);
            const t = e.querySelector(selectors$7.heroContentWrapper);
            if ((t && t.classList.contains(classes.heroContentTransparent) && this.container.classList.add(classes.transparentWrapper), this.setMinHeight(), this.sliderAnimate)) {
                ...
                this.sliderAnimateOnce && (e = this.slideshow.querySelectorAll(`.${classes.classIsSelected}:not(.${classes.classAosAnimated}) .${classes.classAosAnimate}`)),
                    e.length &&
                        e.forEach((e) => {
                            e.classList.remove(classes.classAosAnimate), this.sliderAnimateOnce && e.classList.add(classes.classAosAnimated);
                        });
            }
            if (this.sliderThumbs.length && this.sliderThumbs.length === this.slideshowSlides.length && e.hasAttribute(selectors$7.dataSlideIndex)) {
                ...
                s && s.classList.remove(classes.classIsSelected), this.sliderThumbs[t].classList.add(classes.classIsSelected);
            }
        }
        setMinHeight() {
            this.setMinHeightFlag &&
                this.slideshowSlides.forEach((e) => {
                    ...
                    if (r) {
                        (o = parseInt(window.getComputedStyle(r).marginTop) + parseInt(window.getComputedStyle(r).marginBottom)), (i = r.offsetHeight + o);
                    }
                    ...
                    i > n && (n = i), null !== this.flkty && this.flkty.maxCellHeight > n && (n = this.flkty.maxCellHeight);
                    ...
                    d && d.style.setProperty("min-height", c), l && this.slideshow.parentElement.style.setProperty("min-height", c);
                });
        }
        positionArrows() {
            if (this.slideshow.hasAttribute(selectors$7.dataArrowPositionMiddle) && this.showArrows) {
                ...
                if (!e) return;
                (this.slideshow.querySelector(selectors$7.flickityPrevArrow).style.top = e.clientHeight / 2 + "px"), (this.slideshow.querySelector(selectors$7.flickityNextArrow).style.top = e.clientHeight / 2 + "px");
            }
        }
        initArrows() {
            ...
            const e = parseInt(this.slideshow.getAttribute(selectors$7.dataSlidesLargeDesktop)),
                ...
                c = Boolean(r || a || n || l);
            this.slideshow.classList.toggle(classes.classSliderArrowsHidden, !c), this.slideshow.classList.toggle(classes.classSliderInitialized, c);
        }
        equalizeHeight() {
        ...
        onUnload() {
            (this.setMinHeightFlag || this.multipleSlides) && window.removeEventListener("resize", this.resizeEvent), this.slideshow && this.flkty && ((this.flkty.options.watchCSS = !1), this.flkty.destroy());
        }
        onBlockSelect(e) {
            ...
            this.multipleSlides && !this.slideshow.classList.contains(classes.classSliderInitialized) && (s = 0), this.slideshow.classList.add(classes.classIsSelected), this.flkty.selectCell(s), this.flkty.stopPlayer();
        }
        onBlockDeselect() {
            this.slideshow && (this.slideshow.classList.remove(classes.classIsSelected), this.autoPlay && this.flkty.playPlayer());
        }
    }
    const slider = {
        onLoad() {
    ...
    function t(e) {
        ...
        return {
            ...
            width: i - s,
            top: { y: a + o, x: s + (i - s) / 2 },
            bottom: { y: a + r, x: s + (i - s) / 2 },
            left: { y: o + (r - o) / 2, x: s },
            right: { y: o + (r - o) / 2, x: i },
            topLeft: { y: a + o, x: s },
            bottomLeft: { y: a + r, x: s },
            topRight: { y: a + o, x: i },
            bottomRight: { y: a + r, x: i },
        };
    }
    function e(e, s, i) {
        var o = t(s)[i],
            r = t(e),
            a = window.pageYOffset,
            n = { top: a, bottom: a + window.innerHeight, left: 0, right: window.innerWidth },
            l = {
    ...
    (r.prototype.setState = function (e, t) {
        ...
        (r.prototype.pin = function () {
            ...
            if (!this.state.busy && !this.state.pinned) {
                ...
                var i = o(function () {
                    ...
                    a = o(function () {
                        t.popover.classList.add("is-visible"), t.popover.setAttribute("tabindex", "0"), t.popover.setAttribute("aria-hidden", "false");
                    }),
                    n = o(function () {
                ...
                (e || (!this.state.busy && this.state.pinned)) &&
                    o(function () {
                        ...
                        var e = o(function () {
                            ...
                            a = o(function () {
                                t.popover.classList.remove("is-hiding"), t.popover.classList.remove("is-visible"), t.setState({ busy: !1, pinned: !1, requestClose: !1 });
                            });
                        s(e, i(t.transitionSpeed), r, a)(), t.onChange && t.onChange({ pinned: !1 });
                    }, 0)();
        }),
        ...
        (r.prototype.createPopover = function (e) {
            ...
            return (t.className = "poppy"), (t.role = "dialog"), t.setAttribute("aria-label", "Share Dialog"), t.setAttribute("aria-hidden", "true"), "string" == typeof e ? (t.innerHTML = e) : t.appendChild(e), t;
        });
    const selectors$8 = { tooltip: "data-tooltip", tooltipStopMouseEnter: "data-tooltip-stop-mouseenter" },
        classes$1 = { tooltipDefault: "poppy__tooltip" };
    let sections$1 = {};
    class Tooltip {
        constructor(e, t = {}) {
            (this.tooltip = e),
                this.tooltip.hasAttribute(selectors$8.tooltip) &&
    ...
    const tooltipSection = {
        ...
        selectors$9 = { copyClipboard: "[data-copy-clipboard]", tooltip: "data-tooltip" },
        sections$2 = {};
    class CopyClipboard {
        constructor(e) {
            (this.container = e.container), (this.copyButtons = this.container.querySelectorAll(selectors$9.copyClipboard)), this.copyButtons.length && this.init();
        }
        init() {
            this.copyButtons.forEach((e) => {
                e.hasAttribute(selectors$9.tooltip) && new Tooltip(e),
                    e.addEventListener("click", function (e) {
                        ...
                        (i.type = "text"), this.appendChild(i);
                        ...
                        (o.value = s),
                            ...
                            this.removeChild(o),
                            this.hasAttribute(selectors$9.tooltip) &&
                                t > 749 &&
                                (this.dispatchEvent(new CustomEvent("poppy:init", { bubbles: !0 })),
                                setTimeout(() => {
    ...
    const parallaxHero = {
            onLoad() {
                ...
                this.container.querySelectorAll("[data-parallax-wrapper]").forEach((e) => {
                    ...
                    sections$3[this.id].push(new Rellax(t, { center: !0, round: !0, frame: e }));
                }),
                    window.addEventListener("load", () => {
        ...
        classes$2 = { classOpen: "open", classActive: "active", classSubmenu: "submenu" },
        sections$4 = {};
    class Article {
        constructor(e) {
        ...
        sidebarNav() {
            this.navStates(),
                this.container.addEventListener("click", (e) => {
                    ...
                    !((window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth) < theme.sizes.small) &&
                        o &&
                        r &&
                        (r.parentElement.classList.toggle(classes$2.classActive), r.classList.toggle(classes$2.classOpen), r.setAttribute("aria-expanded", r.classList.contains(classes$2.classOpen)), slideToggle(r), e.preventDefault());
                }),
                this.widgetCategories &&
                    ((this.widgetCategoriesNext = this.widgetCategories.nextSibling), (this.widgetCategoriesParentNode = this.widgetCategories.parentNode), this.categories(), document.addEventListener("theme:resize", this.resizeEvent));
        }
        navStates() {
            ...
            e.length &&
                e.forEach((e) => {
                    if (e.getAttribute("href") === window.location.pathname) {
                        ...
                        if ((e.closest("li").classList.add(classes$2.classActive), !t)) return;
                        t.classList.add(classes$2.classActive);
                        const s = t.querySelector(`.${classes$2.classSubmenu}`);
                        s && (s.classList.toggle(classes$2.classOpen), s.setAttribute("aria-expanded", s.classList.contains(classes$2.classOpen)), showElement(s));
                    }
                });
        }
        categories() {
    ...
    register("article", [articleSection, slider, copyClipboard, parallaxHero]), register("blog-template", [slider]), register("hero", parallaxHero);
    const selectors$b = {
        ...
        classes$3 = { listVisible: "popout-list--visible", currentSuffix: "--current", classPopoutAlternative: "popout-container--alt", visible: "is-visible" };
    let sections$5 = {};
    class Popout {
        constructor(e) {
            (this.container = e),
        ...
        unload() {
            this.popoutOptions.length &&
                this.popoutOptions.forEach((e) => {
                    e.removeEventListener("clickDetails", this.popupOptionsClickEvent), e.removeEventListener("click", this._connectOptionsDispatchEvent);
                }),
        ...
        popupToggleClick(e) {
            ...
            e.currentTarget.setAttribute(selectors$b.ariaExpanded, !t), this.popoutList.classList.toggle(classes$3.listVisible);
        }
        ...
        popupOptionsClick(e) {
            if ("#" === e.target.closest(selectors$b.popoutOptions).attributes.href.value) {
                e.preventDefault();
                let t = "";
                if ((e.currentTarget.getAttribute(selectors$b.dataValue) && (t = e.currentTarget.getAttribute(selectors$b.dataValue)), (this.popoutInput.value = t), this.popoutPrevent)) {
                    this.popoutInput.dispatchEvent(new Event("change")), !e.detail.preventTrigger && this.popoutInput.hasAttribute(selectors$b.popoutQuantity) && this.popoutInput.dispatchEvent(new Event("input"));
                    ...
                    o && (o.classList.remove(`${i}`), e.currentTarget.parentElement.classList.add(`${i}`));
                    const r = this.popoutList.querySelector(`[${selectors$b.ariaCurrent}]`);
                    r && r.hasAttribute(`${selectors$b.ariaCurrent}`) && (r.removeAttribute(`${selectors$b.ariaCurrent}`), e.currentTarget.setAttribute(`${selectors$b.ariaCurrent}`, "true")),
        ...
        updatePopout() {
            ...
            e
                ? (e.dispatchEvent(new CustomEvent("clickDetails", { cancelable: !0, bubbles: !0, detail: { preventTrigger: !0 } })), e.parentElement.nextSibling || this.container.classList.add(classes$3.classPopoutAlternative))
                : this.container.classList.add(classes$3.classPopoutAlternative);
        }
        containerKeyup(e) {
            e.which === window.theme.keyboardKeys.ESCAPE && (this._hideList(), this.popoutToggle.focus());
        }
        bodyClick(e) {
        ...
        _connectOptions() {
            this.popoutOptions.length &&
                this.popoutOptions.forEach((e) => {
                    e.addEventListener("clickDetails", this.popupOptionsClickEvent), e.addEventListener("click", this._connectOptionsDispatchEvent);
                });
        }
        _connectOptionsDispatch(e) {
            const t = new CustomEvent("clickDetails", { cancelable: !0, bubbles: !0, detail: { preventTrigger: !1 } });
        ...
        _hideList() {
            this.popoutList.classList.remove(classes$3.listVisible), this.popoutToggle.setAttribute(selectors$b.ariaExpanded, !1);
        }
    }
    const popoutSection = {
            onLoad() {
        ...
        selectors$c = { newsletterForm: "[data-newsletter-form]", newsletterHeading: "[data-newsletter-heading]" },
        classes$4 = { success: "has-success", error: "not-success", hide: "hide" },
        sections$6 = {};
        ...
        showMessage() {
            if ((this.readStorage(), this.newsletter.id === this.formID)) {
                ...
                -1 !== window.location.search.indexOf("?customer_posted=true")
                    ? (e.classList.remove(classes$4.error), e.classList.add(classes$4.success), t && t.classList.add(classes$4.hide))
                    : -1 !== window.location.search.indexOf("accepts_marketing") && (e.classList.remove(classes$4.success), e.classList.add(classes$4.error), t && t.classList.add(classes$4.hide)),
                    this.scrollToForm(e);
            }
        }
        scrollToForm(e) {
    ...
    class ProductGridReviews {
        constructor(e) {
            (this.container = e.container), (this.showReviews = "false" !== this.container.getAttribute(selectors$d.reviews)), (this.reviewsAppInstalled = "function" == typeof window.SPR), this.init();
        }
        init() {
            this.showReviews && this.reviewsAppInstalled && (window.SPR.initDomEls(), window.SPR.loadBadges());
        }
    }
    ...
    var selectors$e = { idInput: '[name="id"]', planInput: '[name="selling_plan"]', optionInput: '[name^="options"]', quantityInput: '[name="quantity"]', propertyInput: '[name^="properties"]' };
    ...
    class NativeScrollbar {
        constructor(e) {
            (this.scrollbar = e),
                ...
                this.scrollbar.hasAttribute(selectors$f.elements.scrollbarAttribute) && (this.init(), this.resize()),
        ...
        goToNext() {
            ...
            this.move(e), this.arrowPrev.classList.remove(selectors$f.classes.hide), this.toggleNextArrow();
        }
        goToPrev() {
            ...
            this.move(t), this.arrowNext.classList.remove(selectors$f.classes.hide), this.togglePrevArrow();
        }
        toggleNextArrow() {
            setTimeout(() => {
    ...
    const defaults = { color: "ash" },
        ...
        classes$5 = { visible: "is-visible", stopEvents: "no-events" };
    class ColorMatch {
        constructor(e = {}) {
    ...
    class Swatch {
        constructor(e) {
            (this.element = e), (this.colorString = e.getAttribute(selectors$g.swatch)), (this.image = e.getAttribute(selectors$g.image)), (this.variant = e.getAttribute(selectors$g.variant));
        ...
        handleEvents() {
            (this.outer = this.element.closest(selectors$g.outerGrid)),
                this.outer &&
                    ...
                    this.button.closest(selectors$g.formGridSwatch) &&
            ...
            if (
                ...
                window
                    ...
                    .then((e) => {
                        ...
                        this.slide.style.setProperty("background-color", "#fff"), this.slide.style.setProperty("background-image", `url("${t}")`);
                    })
                    .catch((e) => {
                        console.log(`Error: ${e}`);
                    });
    ...
    class GridSwatch {
        constructor(e, t) {
            (this.counterSwatches = e.parentNode.previousElementSibling), (this.template = document.querySelector(selectors$g.template).innerHTML), (this.wrap = e), (this.container = t), (this.handle = e.getAttribute(selectors$g.handle));
            ...
            (this.wrap.innerHTML = ""),
                ...
                this.swatches.forEach((e) => {
                    ...
                    if (t) {
                        ...
                        this.wrap.innerHTML += Sqrl.render(this.template, { color: e, uniq: `${this.product.id}-${t.id}`, variant: t.id, available: t.available, image: s });
                    }
                }),
                (this.swatchElements = this.wrap.querySelectorAll(`[${selectors$g.swatch}]`)),
                this.counterSwatches.hasAttribute(selectors$g.swatchCount) &&
                    ...
                    this.counterSwatches.addEventListener("mouseenter", () => {
                        this.wrap.closest(selectors$g.link).classList.add(classes$5.stopEvents), this.counterSwatches.nextElementSibling.classList.add(classes$5.visible);
                    }),
                    this.counterSwatches.closest(selectors$g.outerGrid).addEventListener("mouseleave", () => {
                        this.wrap.closest(selectors$g.link).classList.remove(classes$5.stopEvents), this.counterSwatches.nextElementSibling.classList.remove(classes$5.visible);
                    })),
    ...
    const makeGridSwatches = (e) => {
        ...
        selectors$h = {
            ...
            times: { debounce: 500, delay: 400, delaySmall: 200, delayMedium: 2e3, delayLarge: 5e3 },
            imageSize: "800x800",
        },
        instances$1 = [];
    class QuickAddProduct {
        constructor(e) {
            (this.cart = window.cart),
                ...
                theme.enableQuickAdd && (this.accessibility(), this.show(), this.hide(), this.errorHandle());
        }
        initNativeScrollbar() {
        ...
        getForm() {
            ...
            fetch(e + "/products/" + this.quickAddLabel.getAttribute(selectors$h.elements.quickAddLabel) + "?section_id=api-quick-add")
                .then((e) => e.text())
                .then((e) => {
                    const t = document.createElement("div");
                    t.innerHTML = e;
                    ...
                    (this.quickAddFormHolder.innerHTML = s.replaceAll("||collection-index||", i)), this.loadForm();
                })
                .catch((e) => {
                    console.warn(e);
                });
        ...
        loadForm() {
            ...
            e && t
                ? ((this.productJSON = JSON.parse(this.productElemJSON.innerHTML)), (this.productOptionsJSON = JSON.parse(this.productOptionsElemJSON.innerHTML)), this.initForm())
                : console.error("Missing product JSON or product options with values JSON");
        }
        initForm() {
            this.filterFirstOptionValues(),
                (this.productForm = new ProductForm(this.form, this.productJSON, { onOptionChange: this.onOptionChange.bind(this) })),
        ...
        onOptionChange(e) {
            ...
            this.changeVariantImage(e.dataset.variant),
                (r && this.accessibilityStopEvent) ||
                    ...
                    t.hasAttribute(selectors$h.elements.goToNextElement) && (s.classList.remove(selectors$h.classes.active), s.nextElementSibling.classList.add(selectors$h.classes.active)),
                    t.hasAttribute(selectors$h.elements.quickAddElement) &&
                        e.dataset.variant.available &&
                        (theme.cartDrawerEnabled && (this.quickAddLabel.classList.remove(selectors$h.classes.hide), this.quickAddLabel.classList.add(selectors$h.classes.loading)),
                        this.html.dispatchEvent(new CustomEvent("cart:add-to-cart", { bubbles: !0, detail: { element: this.holder, label: this.quickAddLabel, data: { id: e.dataset.variant.id, quantity: 1 } } })),
                         setTimeout(() => {
            ...
            this.backButtons.length &&
                this.backButtons.forEach((e) => {
                    e.addEventListener("click", (t) => {
                        ...
                        if ((o === this.quickAddLabel && s && (this.themeAccessibility.lastFocused = this.quickAddLabel), o === this.quickAddLabel && this.enableMobileMode && (o = this.buttonQuickAddMobile), o !== this.quickAddLabel)) {
                        ...
                        o !== this.buttonQuickAddMobile && (s && this.accessibilityTrapFocus(o), o.classList.add(selectors$h.classes.active, selectors$h.classes.select)),
        ...
        toggleClasses() {
            if ((this.holder.classList.add(selectors$h.classes.visible), this.selectOption && this.selectOption.length && "&nbsp;" !== this.quickAddFormHolder.innerHTML)) {
                this.quickAddLabel.classList.add(selectors$h.classes.hide);
                0 === Array.from(this.selectOption).filter((e) => e.classList.contains(selectors$h.classes.active)).length &&
                    (this.selectOption[0].classList.add(selectors$h.classes.active),
                    this.body.classList.contains(selectors$h.classes.focus) &&
        ...
        addFirstVariantIsDefault(e) {
            ...
            e &&
                t.available &&
                (theme.cartDrawerEnabled && (this.quickAddLabel.classList.remove(selectors$h.classes.hide), this.quickAddLabel.classList.add(selectors$h.classes.loading)),
                this.html.dispatchEvent(new CustomEvent("cart:add-to-cart", { bubbles: !0, detail: { element: this.holder, label: this.quickAddLabel, data: { id: t.id, quantity: 1 } } })));
        }
        show() {
            this.buttonQuickAddMobile &&
                this.buttonQuickAddMobile.addEventListener("click", () => {
                    (this.enableMobileMode = !0),
                        ...
                        "&nbsp;" !== this.quickAddFormHolder.innerHTML || this.quickAddFormIsLoaded
                            ? (this.toggleClasses(),
                              this.buttonQuickAddMobile.classList.remove(selectors$h.classes.loading),
                              this.buttonQuickAddMobile.classList.add(selectors$h.classes.hide),
                ...
                this.productGrid &&
                    this.productGrid.addEventListener("mouseenter", () => {
                        (this.enableMobileMode = !1), this.hideOtherHolders(), this.quickAddFormHolder && "&nbsp;" === this.quickAddFormHolder.innerHTML && !this.quickAddFormIsLoaded && this.getForm();
                    }),
                this.quickAddLabel &&
                    (this.quickAddLabel.addEventListener("focusin", () => {
                        (this.enableMobileMode = !1), "&nbsp;" !== this.quickAddFormHolder.innerHTML || this.quickAddFormIsLoaded || this.getForm();
                    }),
                    this.quickAddLabel.addEventListener("click", () => {
                        this.enableMobileMode = !1;
                        this.quickAddLabel.classList.contains(selectors$h.classes.added) ||
                            this.quickAddLabel.classList.contains(selectors$h.classes.disable) ||
                            null === this.productJSON ||
                            ((this.selectedOptions = []), this.addFirstVariantIsDefault(this.quickAddLabel.hasAttribute(selectors$h.elements.quickAddElement)), "&nbsp;" !== this.quickAddFormHolder.innerHTML && this.toggleClasses());
                    })),
        ...
        accessibility() {
            this.productGrid.addEventListener("keyup", (e) => {
                if ((e.keyCode === window.theme.keyboardKeys.TAB && (this.accessibilityStopEvent = !0), e.keyCode === window.theme.keyboardKeys.ENTER)) {
                    this.accessibilityStopEvent = !1;
        ...
        accessibilityTrapFocus(e) {
            this.a11y.removeTrapFocus(), this.a11y.trapFocus(e, { elementToFocus: e.querySelector(selectors$h.elements.backButton) });
        }
        filterAvailableOptions(e, t, s = !0) {
            const i = this.productJSON.variants.filter((s) => {
                if (!(s.options.length > 1)) return s[`option${t}`] === e && s.available;
                {
                    let i = [];
                    if (
        ...
        filterFirstOptionValues() {
            this.productOptionsJSON[0].values.forEach((e) => {
                if (0 === this.productJSON.variants.filter((t) => t.option1 === e && t.available).length && void 0 !== this.selectOption[0]) {
                    ...
                    t && ((t.checked = !1), (t.disabled = !0)), s && (s.classList.add(selectors$h.classes.disable), s.setAttribute("tabindex", -1));
                }
            });
        }
        disableUnavailableValues() {
            this.selectOption &&
                this.selectOption.forEach((e) => {
                    ...
                    t.forEach((t) => {
                        e.classList.contains(selectors$h.classes.select) || ((t.checked = !1), (t.disabled = !0)),
                            this.filteredOptions.forEach((e) => {
                                e.values.includes(t.value) && (t.disabled = !1);
                            });
                    }),
                        s.forEach((t) => {
                            e.classList.contains(selectors$h.classes.select) || (t.setAttribute("tabindex", -1), t.classList.add(selectors$h.classes.disable)),
                                this.filteredOptions.forEach((e) => {
                                    e.values.includes(t.getAttribute(`${selectors$h.elements.popupoutOptionValue}`)) && (t.classList.remove(selectors$h.classes.disable), t.setAttribute("tabindex", 1));
                                });
                        });
                });
        }
        ...
        changeVariantImage(e) {
            if (e && e.featured_media && void 0 !== e.featured_media) {
                ...
                this.featuredImageHolder.style.setProperty("background-image", `url(${t})`), this.featuredImageHolder.closest(selectors$h.elements.productImagesHolder).classList.add(selectors$h.classes.visible);
            }
        }
        resetOptions(e) {
            e.querySelectorAll(selectors$h.elements.input).forEach((e) => {
                ...
                e.querySelectorAll(selectors$h.elements.popupoutOption).forEach((e) => {
                    e.classList.remove(selectors$h.classes.disable), e.setAttribute("tabindex", 1);
                });
        }
        hideOtherHolders() {
            ...
            e &&
                e.forEach((e) => {
                    if (e !== this.holder) {
                        ...
                        t && (t.setAttribute(selectors$h.elements.ariaExpanded, !1), t.nextElementSibling.classList.remove(selectors$h.classes.popupoutVisible)),
        ...
        resetInputsOfInstance() {
            this.selectOption &&
                ...
                this.selectOption.forEach((e) => {
                    ...
                    const t = e.querySelector(selectors$h.elements.popupoutToggle);
                    t && ((t.innerText = theme.strings.selectValue), t.setAttribute(selectors$h.elements.ariaExpanded, !1)), this.resetOptions(e);
                }),
                this.filterFirstOptionValues(),
                (this.filteredOptions = []));
        }
        resetButtonsOfInstance() {
            this.quickAddLabel.classList.remove(selectors$h.classes.select, selectors$h.classes.added, selectors$h.classes.visible), this.buttonQuickAddMobile.classList.remove(selectors$h.classes.hide);
        }
        errorHandle() {
            this.html.addEventListener("cart:add-to-error", (e) => {
                ...
                t.querySelector(`[${selectors$h.elements.quickAddLabel}]`).classList.remove(selectors$h.classes.visible, selectors$h.classes.added, selectors$h.classes.loading),
                    ...
                    setTimeout(() => {
                        t.classList.remove(selectors$h.classes.error), t.classList.add(selectors$h.classes.visible), t.previousElementSibling.classList.remove(selectors$h.classes.hide);
                    }, selectors$h.times.delayLarge);
            });
        }
    }
    const quickAddProduct = {
        ...
        classes$6 = { classInitialized: "is-initialized" };
    class RangeSlider {
        constructor(e) {
            (this.container = e.container),
        ...
        onChanged(e, t) {
            this.slider.hasAttribute(selectors$i.dataFilterUpdate) && this.slider.dispatchEvent(new CustomEvent("range:filter:update", { bubbles: !0 }));
        }
        calculateValue() {
            ...
            this.selectedTouch === this.touchLeft && this.slider.setAttribute(selectors$i.dataMinValue, t), this.selectedTouch === this.touchRight && this.slider.setAttribute(selectors$i.dataMaxValue, s);
        }
    }
    const selectors$j = {
    ...
    class FiltersForm {
        constructor(e) {
            (this.form = e.container.querySelector(selectors$j.form)), (this.filtersInputs = []), this.form && (new RangeSlider(this.form), (this.filtersInputs = this.form.querySelectorAll(selectors$j.inputs)), this.init());
        }
        init() {
        ...
        updateRange() {
            if (this.form && "function" == typeof this.form.submit) {
                ...
                if (e && t && s && i && e.hasAttribute(selectors$j.rangeMinValue) && t.hasAttribute(selectors$j.rangeMaxValue)) {
                    ...
                    (o === a && r === n) || ((s.value = a), (i.value = n), this.form.submit());
                }
            }
        }
    }
    const collectionFiltersForm = {
        ...
        classes$7 = { expanded: "expanded", expanding: "expanding", noMobileAnimation: "no-mobile-animation", hidden: "is-hidden", active: "is-active" };
    let sections$7 = {};
    class Collection {
        constructor(e) {
            (this.container = e.container),
        ...
        init() {
            this.sort && this.initClick(),
                ...
                this.collectionSidebarHeading &&
                    this.collectionSidebarHeading.forEach((e) => {
                        e.addEventListener("click", (t) => {
                            t.preventDefault(), e.classList.toggle(classes$7.active), slideToggle(e.nextElementSibling), e.nextElementSibling.nextElementSibling && slideToggle(e.nextElementSibling.nextElementSibling);
                        });
                    }),
                this.swatches &&
                    this.swatches.forEach((e) => {
        ...
        onClick(e) {
            const t = e.currentTarget.getAttribute(selectors$k.sortValue),
                ...
                i = s.searchParams;
            i.set("sort_by", t), (s.search = i.toString()), window.location.replace(s.toString());
        }
        initClick() {
        ...
        removeUnusableFilters() {
            ...
            e.length > 0 &&
                e.forEach((e) => {
                    ...
                    t || s || (hideElement(e), hideElement(e.parentElement.querySelector(selectors$k.collectionSidebarHeading)));
                });
        }
        showSidebarCallback() {
            ...
            (e < theme.sizes.small || null !== t) && document.dispatchEvent(new CustomEvent("theme:scroll:lock", { bubbles: !0, detail: s }));
        }
        hideSidebar() {
        ...
        collectionSidebarClose(e) {
            e.preventDefault(), this.hideSidebar();
        }
        groupTagsButtonClick() {
            this.collectionSidebar.classList.contains(classes$7.expanded) ? this.showSidebarCallback() : document.dispatchEvent(new CustomEvent("theme:scroll:unlock", { bubbles: !0 }));
        }
        onUnload() {
    ...
    class Ticker {
        ...
        checkWidth() {
            ...
            if (this.frame.clientWidth - e < this.comparitor.clientWidth || this.stopClone) {
                if ((this.text.classList.add(selectors$l.animationClass), 1 === this.scale.childElementCount)) {
                    if (((this.clone = this.text.cloneNode(!0)), this.clone.setAttribute(selectors$l.clone, ""), this.scale.appendChild(this.clone), this.stopClone))
                        for (let e = 0; e < 10; e++) {
                            const e = this.text.cloneNode(!0);
                            e.setAttribute(selectors$l.clone, ""), this.scale.appendChild(e);
                        }
                ...
                e && this.scale.removeChild(e), this.text.classList.remove(selectors$l.animationClass);
            }
        }
    }
    const selectors$m = {
    ...
    class Bar {
        constructor(e) {
            (this.barHolder = e), (this.locationPath = location.href), (this.slides = this.barHolder.querySelectorAll(selectors$m.barSlide)), (this.slider = this.barHolder.querySelector(selectors$m.slider)), this.init();
        }
        init() {
            this.removeAnnouncement(), this.slider && this.initSliders(), this.slider || this.initTickers(!0);
        }
        removeAnnouncement() {
        ...
        toggleTicker(e, t) {
            ...
            t &&
                i &&
                (s.setAttribute("data-stop", ""),
                s.querySelectorAll(selectors$m.tickerText).forEach((e) => {
                    e.classList.remove("ticker--animated"), (e.style.transform = `translate3d(${-(i.offsetLeft - i.clientWidth)}px, 0, 0)`);
                })),
                !t &&
                    i &&
                    (s.querySelectorAll(selectors$m.tickerText).forEach((e) => {
                        e.classList.add("ticker--animated"), e.removeAttribute("style");
                    }),
    ...
    const selectors$n = {
        ...
        classes$8 = { isVisible: "drawer--visible", isFocused: "is-focused", headerStuck: "js__header__stuck" };
    let sections$9 = {};
    class Drawer {
        constructor(e) {
            (this.drawer = e),
        ...
        connectDrawer() {
            this.drawer.addEventListener("theme:drawer:toggle", () => {
                this.drawer.classList.contains(classes$8.isVisible) ? this.drawer.dispatchEvent(new CustomEvent("theme:drawer:close", { bubbles: !0 })) : this.drawer.dispatchEvent(new CustomEvent("theme:drawer:open", { bubbles: !0 }));
            }),
        ...
        closers() {
            this.wrapper.addEventListener(
                "keyup",
                function (e) {
                    e.which === window.theme.keyboardKeys.ESCAPE && (this.hideDrawer(), this.buttons[0].focus());
                }.bind(this)
            ),
        ...
        showDrawer() {
            document.dispatchEvent(new CustomEvent("theme:drawer:close", { bubbles: !1 })),
                this.buttons.forEach((e) => {
                    e.setAttribute("aria-expanded", !0), e.classList.add(classes$8.isVisible);
                }),
                ...
                document.dispatchEvent(new CustomEvent("theme:scroll:lock", { bubbles: !0, detail: this.drawerInner }));
        }
        hideDrawer() {
            this.buttons.forEach((e) => {
                e.setAttribute("aria-expanded", !0), e.classList.remove(classes$8.isVisible);
            }),
    ...
    const drawer = {
        ...
        selectors$o = { announcement: "[data-announcement-wrapper]", transparent: "data-header-transparent", header: "[data-header-wrapper] header", headerIsNotFixed: '[data-header-sticky="static"]' },
        classes$9 = {
    ...
    class Sticky {
        constructor(e) {
            ...
            (this.headerHeight = document.querySelector(selectors$o.header).clientHeight),
                ...
                this.sticks && ((this.stickDown = s), this.scrollDownInit(), document.body.classList.add(classes$9.hasStickyHeader)),
        ...
        listenScroll(e) {
            e.detail.down
                ? (!this.currentlyStuck && e.detail.position > this.stickDown && this.stickSimple(), !this.currentlyBlurred && e.detail.position > this.blur && this.addBlur())
                : (e.detail.position <= this.stickUp && this.unstickSimple(), e.detail.position <= this.blur && this.removeBlur());
        }
        stickSimple() {
            this.animated && this.cls.add(classes$9.stuckAnimated), this.cls.add(classes$9.stuck), this.wrapper.setAttribute(selectors$o.transparent, !1), (this.currentlyStuck = !0);
        }
        unstickSimple() {
            document.documentElement.hasAttribute("data-scroll-locked") ||
                (this.cls.remove(classes$9.stuck), this.wrapper.setAttribute(selectors$o.transparent, theme.transparentHeader), this.animated && this.cls.remove(classes$9.stuckAnimated), (this.currentlyStuck = !1));
        }
        scrollDownInit() {
    ...
    const stickyHeader = {
        ...
        classes$a = { isVisible: "is-visible", meganavVisible: "meganav--visible", meganavIsTransitioning: "meganav--is-transitioning" };
    let sections$b = {},
        disclosures = {};
    class HoverDisclosure {
        ...
        handleTablets() {
            this.trigger.addEventListener(
                "touchstart",
                function (e) {
                    this.disclosure.classList.contains(classes$a.isVisible) || (e.preventDefault(), this.showDisclosure());
                }.bind(this),
                { passive: !0 }
            );
        }
    ...
    const hoverDisclosure = {
        ...
        selectors$q = { count: "data-cart-count" };
    class Totals {
        constructor(e) {
            (this.section = e), (this.counts = this.section.querySelectorAll(`[${selectors$q.count}]`)), (this.cart = null), this.listen();
        }
        listen() {
        ...
        update() {
            this.cart &&
                this.counts.forEach((e) => {
                    e.setAttribute(selectors$q.count, this.cart.item_count), (e.innerHTML = `${this.cart.item_count}`);
                });
        }
    }
    const headerTotals = {
    ...
    class SearchPredictive {
        constructor(e) {
            (this.input = e), (this.key = this.input.getAttribute(selectors$r.input));
            const t = `[id='${this.key}']`;
            ...
            this.input.addEventListener(
                ...
                debounce(
                    function (e) {
                        ...
                        t && t.length > 1 ? (this.productWrapperOuter.classList.add(selectors$r.loadingClass), this.render(t)) : (this.reset(), this.append.classList.remove(selectors$r.dirtyClass));
                    }.bind(this),
                    300
                )
            ),
        ...
        render(e) {
            fetch(`/search/suggest.json?q=${encodeURIComponent(e)}&resources[type]=product&resources[limit]=8&resources[options][unavailable_products]=last`)
                .then(this.handleErrors)
                .then((e) => e.json())
                .then((e) => ((this.result = e.resources.results), this.fetchProducts(e.resources.results.products)))
                .then((t) => {
                    this.injectTitle(e),
                        setTimeout(() => {
                            this.reset(!1),
        ...
        reset(e = !0) {
            (this.productWrapper.innerHTML = ""), this.append.classList.remove(selectors$r.dirtyClass), (this.input.val = ""), this.accessibility.removeTrapFocus(), e && (this.titleWrapper.innerHTML = "");
        }
        injectTitle(e) {
            let t = window.theme.strings.noResultsFor,
                s = "";
            this.result && this.result.products.length > 0 && ((s = this.result.products.length), (t = window.theme.strings.resultsFor)), (this.titleWrapper.innerHTML = Sqrl.render(this.titleTemplate, { count: s, title: t, query: e }));
        }
        injectProduct(e) {
        ...
        renderProduct(e) {
            ...
            void 0 !== e.media && ((t = e.media[0]), (s = e.media[1])),
                (i = t ? { thumb: themeImages.getSizedImageUrl(t.preview_image.src, "800x800"), alt: t.preview_image.src } : { thumb: window.theme.assets.no_image, alt: "" }),
                s && (o = { thumb: themeImages.getSizedImageUrl(s.preview_image.src, "800x800"), alt: s.preview_image.src });
            const r = e.title.replace(/(<([^>]+)>)/gi, ""),
                a = { ...e, title: r, image: i, secondImage: o };
            return Sqrl.render(this.productTemplate, { product: a });
        }
        handleErrors(e) {
            return e.ok
                ? e
    ...
    const selectors$s = { body: "body", popdownTrigger: "data-popdown-toggle", close: "[data-close-popdown]", input: "[data-predictive-search-input]" },
        classes$b = { isVisible: "is-visible" };
    let sections$c = {};
    class SearchPopdownTriggers {
        constructor(e) {
            (this.trigger = e), (this.key = this.trigger.getAttribute(selectors$s.popdownTrigger)), (this.search = null);
            const t = `[id='${this.key}']`;
            (this.document = document),
        ...
        initTriggerEvents() {
            this.trigger.setAttribute("aria-haspopup", !0),
                ...
                this.trigger.addEventListener("click", (e) => {
                    e.preventDefault(), this.body.classList.contains("is-focused") || this.showPopdown();
                }),
        ...
        showPopdown() {
            document.dispatchEvent(new CustomEvent("theme:drawer:close", { bubbles: !1 })),
                document.dispatchEvent(new CustomEvent("theme:scroll:lock", { bubbles: !0, detail: this.popdown })),
                this.popdown.classList.add(classes$b.isVisible);
            const e = this.input.value;
            (this.input.value = ""), (this.input.value = e), this.accessibility.trapFocus(this.popdown), this.input.focus();
        }
    }
    const searchPopdown = {
            onLoad() {
    ...
    class HeaderMobileSliderule {
        constructor(e) {
            (this.sliderule = e), (this.wrapper = e.closest(selectors$t.wrapper)), (this.key = this.sliderule.id);
        ...
        keyboardEvents() {
            this.trigger.addEventListener(
                ...
                this.sliderule.addEventListener(
                    "keyup",
                    function (e) {
                        e.which === window.theme.keyboardKeys.ESCAPE && (this.hideSliderule(), this.buttons[0].focus());
                    }.bind(this)
                );
        }
        staggerChildAnimations() {
        ...
        closeSliderule() {
            this.pane &&
                this.pane.hasAttribute(selectors$t.sliderulePane) &&
                parseInt(this.pane.getAttribute(selectors$t.sliderulePane)) > 0 &&
                (this.hideSliderule(), parseInt(this.pane.getAttribute(selectors$t.sliderulePane)) > 0 && this.pane.setAttribute(selectors$t.sliderulePane, 0));
        }
    }
    ...
    class Header {
        ...
        unload() {
            document.removeEventListener("theme:resize", this.resizeEventWidth), document.removeEventListener("theme:resize", this.resizeEventOverlay);
        }
        checkForImage() {
            this.overlayedImages = document.querySelectorAll(selectors$u.firstSectionHasImage);
            ...
            this.overlayedImages.length && !e && this.isTransparentHeader
                ? (this.listenOverlay(), this.wrapper.setAttribute(selectors$u.transparent, !0), (document.querySelector(selectors$u.backfill).style.display = "none"), (theme.transparentHeader = !0))
                : (this.wrapper.setAttribute(selectors$u.transparent, !1), (document.querySelector(selectors$u.backfill).style.display = "block"), (theme.transparentHeader = !1)),
                !this.overlayedImages.length || e || this.isTransparentHeader || (this.wrapper.classList.add(selectors$u.overrideBorder), this.subtractHeaderHeight());
        }
        listenOverlay() {
            document.addEventListener("theme:resize", this.resizeEventOverlay), this.subtractAnnouncementHeight();
        }
        listenWidth() {
            document.addEventListener("theme:resize", this.resizeEventWidth), this.checkWidth();
        }
        killDeadLinks() {
        ...
        subtractAnnouncementHeight() {
            ...
            this.overlayedImages.forEach((i) => {
                i.style.setProperty("--full-screen", e - t + "px"), i.style.setProperty("--header-padding", `${s}px`), i.classList.add("has-overlay");
            });
        }
        ...
        getMinWidth() {
            ...
            e.classList.add(selectors$u.cloneClass), document.body.appendChild(e);
    ...
    const header = {
        onLoad() {
            (sections$e = new Header(this.container)), setVarsOnResize();
        },
        onUnload() {
    ...
    const selectors$v = { slider: "[data-slider]", slide: "[data-slide]", thumb: "[data-slider-thumb]" },
        classes$d = { classIsSelected: "is-selected" },
        sections$f = {};
    class Look {
        constructor(e) {
            (this.container = e.container),
                ...
                this.slider &&
                    this.slides.length &&
                    this.thumbs.length &&
                    ((this.resizeEvent = () => this.checkPosition()), this.slider.addEventListener("scroll", this.resizeEvent), document.addEventListener("theme:resize", this.resizeEvent));
        }
        checkPosition() {
        ...
        onUnload() {
            this.slider && this.slides.length && this.thumbs.length && (document.removeEventListener("theme:resize", this.resizeEvent), this.slider.removeEventListener("scroll", this.resizeEvent));
        }
    }
    const lookSection = {
        onLoad() {
    ...
    const selectors$w = {
        ...
        classes$e = { classCurrent: "current", classHide: "hide", classAlt: "alt", classAosAnimate: "aos-animate", classAosNoTransition: "aos-no-transition" },
        sections$g = {};
    class GlobalTabs {
        constructor(e) {
            (this.container = e),
                ...
                this.container && ((this.scrollbarHolder = this.container.querySelectorAll(selectors$w.scrollbarHolder)), this.init(), this.initNativeScrollbar());
        }
        init() {
                    ...
                    t.forEach((t) => {
                        ...
                        t.addEventListener("click", () => {
                            ...
                            t.addEventListener("keyup", (e) => {
                                (e.which !== window.theme.keyboardKeys.SPACE && e.which !== window.theme.keyboardKeys.ENTER) ||
                                    !this.body.classList.contains("is-focused") ||
                                    (this.tabChange(t, i),
                                    i.querySelector("a, input") && ((this.accessibility.lastFocused = t), this.accessibility.a11y.trapFocus(i, { elementToFocus: i.querySelector("a:first-child, input:first-child") })));
                            });
                    });
        }
        tabChange(e, t) {
            ...
            s.length &&
                s.forEach((e) => {
                    e.classList.remove(classes$e.classAosAnimate),
                        t &&
                            (e.classList.add(classes$e.classAosNoTransition),
                            setTimeout(() => {
                                e.classList.remove(classes$e.classAosNoTransition), e.classList.add(classes$e.classAosAnimate);
                            }, 100));
                });
        }
        initNativeScrollbar() {
        ...
        checkRecentTab() {
            ...
            if (e) {
                ...
                s && (s.classList.remove(classes$e.classHide), this.animateItems(s, !1)), this.checkVisibleTabLinks(), this.initNativeScrollbar();
            }
        }
        hideRelatedTab() {
            ...
            if (i.length > s) {
                ...
                e && (i[s].classList.add(classes$e.classHide), e.dispatchEvent(new Event("click")), this.initNativeScrollbar());
            }
        }
        onBlockSelect(e) {
    ...
    class InitSlider {
        ...
        destroySlider() {
            this.slideshow.classList.contains(selectors$x.sliderEnabled) && this.flkty.destroy(), this.thumbs && (this.thumbs.innerHTML = ""), null !== this.flktyThumbs && (this.flktyThumbs.destroy(), (this.flktyThumbs = null));
        }
        createSlider() {
            if (!this.slideshow) return;
            const e = this,
            ...
            if (((this.flkty = new FlickityFade(this.slideshow, s)), this.flkty.resize(), t)) {
            ...
            this.flkty.on("change", function (t) {
                ...
                if (e.thumbs) {
                    ...
                    i && ((s = Array.from(i.parentElement.children).indexOf(i)), i.classList.remove(selectors$x.classSelected)), o && o.parentElement.classList.add(selectors$x.classSelected);
                }
                const i = this.cells[s].element,
                    o = this.selectedElement;
                i.dispatchEvent(new CustomEvent("mediaHidden")), o.classList.remove(selectors$x.classMediaHidden);
            }),
                this.flkty.on("settle", function () {
                    ...
                    "model" === i || "video" === i || "external_video" === i ? ((e.flkty.options.draggable = !1), e.flkty.updateDraggable()) : ((e.flkty.options.draggable = !0), e.flkty.updateDraggable()),
                ...
                e.container.addEventListener("click", function (t) {
                    ...
                    if (s.matches(selectors$x.productSlideThumb) || s.closest(selectors$x.productSlideThumb)) {
                        ...
                        let i,
                            o = 0;
                        (i = s.matches(selectors$x.productSlideThumb) ? s : s.closest(selectors$x.productSlideThumb)), (o = parseInt(i.getAttribute(selectors$x.dataThumbIndex))), e.flkty.select(o);
                    }
                });
        }
        createThumbSlider() {
            let e = { autoPlay: !1, prevNextButtons: !1, contain: !0, pageDots: !1, adaptiveHeight: !1, wrapAround: !1, cellAlign: "left" },
            ...
            const s = () => {
                (this.flktyThumbs = new FlickityFade(this.thumbsSlider, e)), this.flktyThumbs.resize();
            };
            t && s(),
                document.addEventListener("theme:resize", () => {
                    (t = (window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth) < theme.sizes.small), t ? s() : null !== this.flktyThumbs && (this.flktyThumbs.destroy(), (this.flktyThumbs = null));
                });
        }
        sliderThumbs(e) {
            const t = e.slides;
            ...
            if (this.thumbs && t.length) {
                ...
                t.forEach((t, s) => {
                    ...
                    "" !== e && ((e = `<div class="thumbs-holder" data-thumbs-slider>${e}</div>`), (this.thumbs.innerHTML = e), this.createThumbSlider());
            }
                    ...
                    t.addEventListener("click", function (e) {
                        ...
                        t.addEventListener("keyup", function (t) {
                            if (13 === t.keyCode) {
                                ...
                                s && (s.dispatchEvent(new Event("focus")), s.dispatchEvent(new Event("select")));
                            }
                        });
                });
        }
    ...
    class LoadVideoYT {
            ...
            (this.container = e),
                ...
                this.player &&
                    ...
                    "youtube" == this.videoType &&
                        ((this.checkPlayerVisibilityFlag = "true" === this.player.getAttribute(selectors$z.dataCheckPlayerVisibility)),
                        ...
                        this.player.hasAttribute(selectors$z.dataHideOptions) &&
            ...
            const e = {
                ...{
                    ...
                    events: {
                        ...
                        onStateChange: (e) => {
                            0 == e.data && e.target.playVideo(), 1 == e.data && e.target.getIframe().parentElement.classList.add(classes$g.loaded);
                        },
                    },
                },
            };
        ...
        checkPlayerVisibility(e) {
            ...
            o.top < 0 && s.clientHeight + o.top >= 0 && (r = !0), r && i && "function" == typeof i.playVideo ? i.playVideo() : !r && i && "function" == typeof i.pauseVideo && i.pauseVideo();
        }
        onUnload() {
    ...
    const selectors$A = { dataVideoId: "data-video-id", dataVideoType: "data-video-type", videoIframe: "[data-video-id]" },
        classes$h = { loaded: "loaded" };
    class LoadVideoNative {
        constructor(e) {
            (this.container = e),
                (this.player = this.container.querySelector(selectors$A.videoIframe)),
                this.player && ((this.videoID = this.player.getAttribute(selectors$A.dataVideoId)), (this.videoType = this.player.getAttribute(selectors$A.dataVideoType)), "native" == this.videoType && this.init());
        }
        init() {
            if (window.isPlyrLoaded) this.loadNativePlayer();
            else {
                loadScript({ name: "video-ui", version: "1.0" }).then(() => this.loadNativePlayer());
            }
        }
        loadNativePlayer() {
            new Shopify.Plyr(this.player, { focusOnPlay: !0 }).on("ready", (e) => {
    ...
    const selectors$B = {
        ...
        classes$i = { classCurrent: "is-current", classCustomLoader: "pswp--custom-loader", classCustomOpen: "pswp--custom-opening", classLoader: "pswp__loader" },
    ...
    class LoadPhotoswipe {
        ...
        initLoader() {
            ...
            } else this.pswpElement.setAttribute(selectors$B.dataOptionClasses, "");
        }
        loadPopup() {
            ...
            this.popupThumbsContainer &&
                ...
                this.popupThumbs.forEach((e, t) => {
                    e.addEventListener("click", (s) => {
                        s.preventDefault(), e.parentElement.querySelector(`.${classes$i.classCurrent}`).classList.remove(classes$i.classCurrent), e.classList.add(classes$i.classCurrent), this.popup.goTo(t);
                    });
                }),
        ...
        onClose() {
            ...
            if ((e && e.parentNode.removeChild(e), this.popupThumbsContainer && this.popupThumbsContainer.firstChild))
        ...
        setCurrentThumb() {
            ...
            if ((e && e.classList.remove(classes$i.classCurrent), !this.popupThumbs)) return;
            const t = this.popupThumbs[this.popup.getCurrentIndex()];
            t.classList.add(classes$i.classCurrent), this.scrollThumbs(t);
        }
        scrollThumbs(e) {
    ...
    class Zoom {
        ...
        createZoom(e) {
            ...
            this.zoomWrappers.forEach((r) => {
                ...
                if ((s.push({ src: a, w: n, h: l, msrc: a }), (o += `<a href="#" class="${classes$j.popupThumb}" style="background-image: url('${a}')"></a>`), (i += 1), t.zoomWrappers.length === i)) {
    ...
    class Video {
        constructor(e) {
            (this.section = e), (this.container = e.container), (this.id = e.id), (this.players = {}), this.init();
        }
        init() {
            ...
            if (s)
                if (window.isPlyrLoaded) this.nativeInitCallback();
                    ...
                    loadScript({ name: "video-ui", version: "1.0" }).then(() => this.nativeInitCallback());
                }
            t && (window.isYoutubeAPILoaded ? this.youTubeInitCallback() : loadScript({ url: "https://www.youtube.com/iframe_api" }).then(() => this.youTubeInitCallback()));
        }
        youTubeInitCallback() {
            for (const e in this.players)
                if ("external_video" === this.players[e].type) {
                    const t = this.players[e],
                        ...
                        i = {
                            ...{
                                playerVars: { cc_load_policy: 0, iv_load_policy: 3, modestbranding: 1, playsinline: 1, autohide: 0, controls: 1, branding: 0, showinfo: 0, rel: 0, fs: 0, wmode: "opaque" },
                                events: {
                                    onStateChange: (e) => {
                                        0 === e.data && s && e.target.seekTo(0);
                                        const t = e.target.getIframe().closest(`[${selectors$D.dataMediaId}]`);
                                        let i = "";
                                        t && (i = t.getAttribute(selectors$D.dataMediaId)), 1 === e.data && this.pauseOtherMedia(i);
                                    },
                                },
                            },
                        };
        ...
        nativeInitCallback() {
            for (const e in this.players)
                if ("video" === this.players[e].type) {
                    const t = this.players[e],
                        s = { loop: { active: "true" === this.players[e].container.closest(`[${selectors$D.dataVideoLooping}]`).getAttribute(selectors$D.dataVideoLooping) }, focusOnPlay: !0 };
                    (this.players[e].player = new Shopify.Plyr(t.element, s)),
                        t.element.addEventListener("play", (e) => {
                            ...
                            let s = "";
                            t && (s = t.getAttribute(selectors$D.dataMediaId)), this.pauseOtherMedia(s);
                        }),
                        (window.isPlyrLoaded = !0),
        ...
        pauseOtherMedia(e) {
            ...
            s.classList.remove(selectors$D.classMediaHidden),
                i.length &&
                    i.forEach((e) => {
                        e.dispatchEvent(new CustomEvent("mediaHidden")), e.classList.add(selectors$D.classMediaHidden);
                    });
        }
    }
    theme.mediaInstances = {};
    const selectors$E = { videoPlayer: "[data-video]", modelViewer: "[data-model]", sliderEnabled: "flickity-enabled", classMediaHidden: "media--hidden" };
    class Media {
        constructor(e) {
            (this.section = e), (this.id = e.id), (this.container = e.container);
        }
        init() {
            new Video(this.section), this.detect3d(), this.launch3d(), new Zoom(this.section), new InitSlider(this.section);
        }
        detect3d() {
    ...
    class PickupAvailability {
        ...
        fetchPickupAvailability(e) {
            ...
            this.drawer && this.body.removeChild(this.drawer),
                t &&
                    s &&
                    fetch(`${window.theme.routes.root}variants/${s.id}/?section_id=api-pickup-availability`)
                        .then((e) => e.text())
                        .then((e) => {
        ...
        openDrawer() {
            this.drawer &&
                ...
                setTimeout(() => {
                    ...
                    this.a11y.removeTrapFocus(), this.a11y.trapFocus(this.drawer, { elementToFocus: e });
                }, 200));
        }
        closeDrawer() {
            this.drawer &&
    ...
    const pickupAvailability = {
        ...
        classes$l = { hide: "hide", variantSoldOut: "variant--soldout", variantUnavailable: "variant--unavailabe", productPriceSale: "product__price--sale" };
    class ProductAddForm {
        ...
        init() {
            ...
            t && (e = t.innerHTML), e ? ((this.productJSON = JSON.parse(e)), this.linkForm()) : console.error("Missing product JSON");
        }
        destroy() {
            this.productForm.destroy();
        }
        linkForm() {
            (this.productForm = new ProductForm(this.productForm, this.productJSON, { onOptionChange: this.onOptionChange.bind(this), onPlanChange: this.onPlanChange.bind(this) })),
        ...
        pushState(e) {
            (this.productState = this.setProductState(e)), this.updateAddToCartState(e), this.updateProductPrices(e), this.updateSubscriptionText(e), this.fireHookEvent(e), this.enableHistoryState && this.updateHistoryState(e);
        }
        updateAddToCartState(e) {
            ...
            this.productJSON.tags.includes(selectors$G.preOrderTag) && (s = theme.strings.preOrder),
                ...
                a.length &&
                    a.forEach((e) => {
                        if (t) {
                            t.available ? e.classList.remove(classes$l.variantSoldOut, classes$l.variantUnavailable) : (e.classList.add(classes$l.variantSoldOut), e.classList.remove(classes$l.variantUnavailable));
                            const s = e.querySelector(selectors$G.originalSelectorId);
                            s && (s.value = t.id);
                        } else e.classList.add(classes$l.variantUnavailable), e.classList.remove(classes$l.variantSoldOut);
                    });
        }
        ...
        updateSubscriptionText(e) {
            ...
            if (this.productState.planSale) {
                const e = t.detail.price_adjustments[0],
                    o = e.value;
                e && "percentage" === e.value_type ? (i.innerHTML = `${o}%`) : (i.innerHTML = themeCurrency.formatMoney(o, theme.moneyFormat)), s.classList.remove(classes$l.hide);
            } else s.classList.add(classes$l.hide);
            t ? ((o.innerHTML = t.detail.description), o.classList.remove(classes$l.hide)) : o && o.classList.add(classes$l.hide);
        }
                ...
                this.productState.available && ((a = t.compare_at_price), (n = t.price)),
                    ...
                    i &&
                        (this.productState.onSale || this.productState.planSale
                            ? (i.classList.remove(classes$l.hide), r.classList.remove(classes$l.hide), o.classList.add(classes$l.productPriceSale))
                            : (i.classList.add(classes$l.hide), r.classList.add(classes$l.hide), o.classList.remove(classes$l.productPriceSale)),
        ...
        updateProductUnits(e) {
            ...
            if ((t && t.unit_price && (i = t.unit_price), s && s.allocation && s.allocation.unit_price && (i = s.allocation.unit_price), i)) {
                ...
                (this.container.querySelector(selectors$G.unitPrice).innerHTML = s), (this.container.querySelector(selectors$G.unitBase).innerHTML = e), showElement(this.container.querySelector(selectors$G.unitWrapper));
            } else hideElement(this.container.querySelector(selectors$G.unitWrapper));
        }
        fireHookEvent(e) {
            const t = e.variant;
            this.container.dispatchEvent(new CustomEvent("theme:variant:change", { detail: { variant: t }, bubbles: !0 }));
        }
        setProductState(e) {
            const t = e.variant,
                s = e.plan,
        ...
        updateProductImage(e) {
            ...
            if (t && t.featured_media) {
                ...
                if (s) {
                    ...
                    if ((i && i.classList.contains(selectors$G.sliderEnabled) && FlickityFade.data(i).select(t), !theme.variables.bpSmall && this.tallLayout)) {
                        const s = e.getBoundingClientRect().top + window.scrollY;
                        if (0 === t && s > window.pageYOffset) return;
                        document.dispatchEvent(new CustomEvent("poppy:close")), window.scrollTo({ top: s, left: 0, behavior: "smooth" });
                    }
                }
            }
        }
    ...
    class GlobalAccordions {
        ...
        accordionEvents() {
            this.accordionToggles.forEach((e) => {
                ...
                "true" === this.accordion.getAttribute(selectors$H.elements.accordionExpandValue) &&
                    (this.accordionToggles[0].classList.add(selectors$H.classes.open), showElement(this.accordionToggles[0].parentElement.querySelector(selectors$H.elements.accordionBody)));
        }
        ...
        onAccordionOpen(e, t, s = !0) {
            e.classList.add(selectors$H.classes.open), slideDown(t), this.closeOtherAccordions(e, s);
        }
        onAccordionClose(e, t, s = !0) {
            e.classList.remove(selectors$H.classes.open), s ? slideUp(t) : hideElement(t);
        }
        onAccordionToggle(e, t) {
            e.classList.toggle(selectors$H.classes.open), slideToggle(t), this.closeOtherAccordions(e);
        }
        onBlockToggle(e, t = !0) {
        ...
        onSelectToggle(e = !0) {
            this.accordionBody &&
                ...
                (e ? this.onAccordionOpen(this.accordionToggles[0], this.accordionBody, !1) : this.onAccordionClose(this.accordionToggles[0], this.accordionBody));
        }
        onSelect() {
    ...
    window.theme.variables = { productPageSticky: !1, bpSmall: !1 };
    const selectors$I = {
            addToCart: "[data-add-to-cart]",
            priceWrapper: "[data-price-wrapper]",
    ...
    class Product {
        constructor(e) {
            ...
            (this.form = this.container.querySelector(selectors$I.form)), this.init(), this.stickyEnabled && this.stickyScroll(), "true" === this.container.getAttribute(selectors$I.dataCartBar) && this.initCartBar();
            const s = "function" == typeof window.SPR;
            this.showReviews && s && (window.SPR.initDomEls(), window.SPR.loadBadges()), this.upsellButton && this.upsellButtonDemensions(), this.modalButton.length > 0 && this.productPopup();
        }
        init() {
        ...
        productPopup() {
            this.modalButton.forEach((e) => {
                e.addEventListener("click", (t) => {
                    ...
                    "none" !== window.getComputedStyle(s).display && (fadeOut(s), this.formWrapper.classList.remove(classes$m.hasPopup), document.dispatchEvent(new CustomEvent("theme:scroll:unlock", { bubbles: !0 }))),
                        "none" === window.getComputedStyle(s).display && (fadeIn(s), this.formWrapper.classList.add(classes$m.hasPopup), document.dispatchEvent(new CustomEvent("theme:scroll:lock", { bubbles: !0, detail: s })));
                });
            });
        }
        upsellButtonDemensions() {
        ...
        stickyScroll() {
            this.stickyScrollCheck(), document.addEventListener("theme:resize", this.resizeEventSticky);
        }
        stickyScrollCheck() {
            ...
            if (e) {
                ...
                i < e.offsetHeight || i < window.innerHeight
                    ? ((theme.variables.productPageSticky = !0), s.classList.add(classes$m.classSticky), this.headerSticky && s.classList.add(classes$m.classStickyHeader))
                    : ((theme.variables.productPageSticky = !1), s.classList.remove(classes$m.classSticky));
            } else s.classList.remove(classes$m.classSticky);
        }
        truncateText() {
            ...
            i.classList.add(t),
                ...
                hideElement(i),
                this.truncateElement.innerHTML !== i.innerHTML ? this.truncateElementHolder.classList.add(classes$m.classExpanded) : (i.remove(), this.truncateElementHolder.classList.remove(classes$m.classExpanded)),
        ...
        toggleTruncatedContent(e) {
            ...
            console.log("toggleTruncateButton>>", t);
            t &&
                t.addEventListener("click", (t) => {
                  console.log("toggleTruncateButton>>", t),
                    t.preventDefault(), e.classList.remove(classes$m.classExpanded), e.classList.add(classes$m.classVisible);
                });
        }
        shareToggle() {
            this.shareButton &&
                this.shareButton.addEventListener("click", function () {
                    ...
                    if (navigator.share && e <= 1024) {
                        ...
                        navigator
                            ...
                            .catch(console.error);
                    } else this.parentElement.classList.toggle(classes$m.classExpanded);
                });
        }
        initCartBar() {
            ...
            t &&
                (t.addEventListener("click", (e) => {
                    e.preventDefault(),
                        e.target.hasAttribute(selectors$I.cartBarAdd)
                            ? (theme.cartDrawerEnabled && (e.target.classList.add(classes$m.classLoading), e.target.setAttribute("disabled", "disabled")),
                              this.form.querySelector(selectors$I.addToCart).dispatchEvent(new Event("click", { bubbles: !0 })))
                ...
                theme.cartDrawerEnabled &&
                    document.addEventListener("product:bar:button", () => {
                        t && t.classList.contains(classes$m.classLoading) && (t.classList.remove(classes$m.classLoading), t.removeAttribute("disabled"));
                    })),
                (this.cartBar = e),
        ...
        scrollToTop() {
            ...
            window.scrollTo({ top: e.getBoundingClientRect().top + window.scrollY, left: 0, behavior: "smooth" });
        }
        scrollTop() {
            const e = window.pageYOffset,
        ...
        scrollToElement(e) {
            ...
            window.scrollTo({ top: e.getBoundingClientRect().top + window.scrollY - t, left: 0, behavior: "smooth" });
    ...
    class Related {
        constructor(e) {
            (this.section = e), (this.sectionId = e.id), (this.container = e.container), this.init(), this.recent();
        }
        init() {
            ...
            fetch(o)
                ...
                .then(function (s) {
                    ...
                    if (o.querySelector(selectors$J.dataRelatedProduct)) {
                        const s = o.innerHTML;
                        hideElement(e), (e.innerHTML = s), slideDown(e);
                    ...
                    } else e.dispatchEvent(new CustomEvent("tabs:hideRelatedTab", { bubbles: !0 }));
                })
                .catch(function () {
                    e.dispatchEvent(new CustomEvent("tabs:hideRelatedTab", { bubbles: !0 }));
                });
        }
        recent() {
            ...
            Shopify.Products.showRecentlyViewed({
                ...
                onComplete: (e, t) => {
                    const s = t.container,
                        ...
                        l = o && r.length >= a;
                    (n || l) &&
                        (l && o.classList.remove("is-hidden"),
                        fadeIn(i),
                        i.dispatchEvent(new CustomEvent("tabs:checkRecentTab", { bubbles: !0 })),
                        r.forEach((e) => {
                            new QuickAddProduct(e);
                        }),
                        makeGridSwatches(t),
    ...
    register("related", [relatedSection, popoutSection, tabs]), register("reviews", accordions);
    const selectors$K = { scrollElement: "[data-block-scroll]", flickityEnabled: "flickity-enabled" },
        sections$k = {};
    class BlockScroll {
        constructor(e) {
            this.container = e.container;
    ...
    const blockScroll = {
        ...
        sections$l = {},
        selectors$L = { logo: "[data-slider-logo]", text: "[data-slider-text]", slide: "[data-slide]", slideData: "data-slide", asNavFor: "#nav-for-", slideIndex: "data-slide-index", flickityEnabled: "flickity-enabled" },
        classes$n = { classIsSelected: "is-selected" };
    class LogoList {
        constructor(e) {
            (this.container = e.container),
        ...
        init() {
            if (this.slideshowText) {
                this.flkty = new FlickityFade(this.slideshowText, { fade: !0, autoPlay: !1, prevNextButtons: !1, cellAlign: "left", contain: !0, pageDots: !1, wrapAround: !1, selectedAttraction: 0.2, friction: 0.6, draggable: !1 });
            ...
            this.logoSlides.forEach((e) => {
                e.addEventListener("click", (e) => {
                    ...
                    if ((this.flkty && this.flkty.select(t), s)) this.flktyNav.select(t), this.slideshowNav.classList.contains(classes$n.classIsSelected) || this.flktyNav.playPlayer();
                    else {
                        const t = this.slideshowNav.querySelector(`.${classes$n.classIsSelected}`);
                        t && t.classList.remove(classes$n.classIsSelected), e.currentTarget.classList.add(classes$n.classIsSelected);
                    }
                });
            }),
        ...
        onUnload() {
            ...
            this.slideshowNav.classList.contains(selectors$L.flickityEnabled) && this.flktyNav.destroy(), this.flkty && this.flkty.destroy(), window.removeEventListener("resize", this.resizeEvent);
        }
        onBlockSelect(e) {
            if (!this.slideshowNav) return;
            ...
            this.slideshowNav.classList.contains(selectors$L.flickityEnabled) ? (this.flktyNav.select(s), this.flktyNav.stopPlayer(), this.slideshowNav.classList.add(classes$n.classIsSelected)) : t.dispatchEvent(new Event("click"));
        }
        onBlockDeselect() {
            this.slideshowNav && this.slideshowNav.classList.contains(selectors$L.flickityEnabled) && (this.flktyNav.playPlayer(), this.slideshowNav.classList.remove(classes$n.classIsSelected));
        }
            ...
            if (s > t) {
                if (!i) {
                    ...
                    e && e.classList.remove(classes$n.classIsSelected),
                        ...
                        (this.flktyNav = new Flickity(this.slideshowNav, { autoPlay: 4e3, prevNextButtons: !1, contain: !0, pageDots: !1, wrapAround: !0, watchCSS: !0, selectedAttraction: 0.05, friction: 0.8, initialIndex: 0 })),
                        this.flkty && (this.flkty.select(0), this.flktyNav.on("change", (e) => this.flkty.select(e)));
                }
            } else i && (this.flktyNav.destroy(), this.logoSlides[0].classList.add(classes$n.classIsSelected), this.flkty && this.flkty.select(0));
        }
        initSlideshowNav() {
            this.setSlideshowNavState(), window.addEventListener("resize", this.resizeEvent);
        }
    }
    ...
    const selectors$M = { videoPlay: "[data-video-play]", videoPlayValue: "data-video-play" };
    class VideoPlay {
    ...
    register("featured-video", [videoPlay, parallaxHero]), register("slideshow", [slider, parallaxHero]);
    const sections$m = {};
    class ImageWithText {
        constructor(e) {
    ...
    register("map", mapSection), register("search", [quickAddProduct, swatchGridSection]);
    const selectors$N = {
        ...
        classes$o = { hide: "hide", hasValue: "has-value", success: "has-success" };
    let sections$n = {};
    class PopupCookie {
        constructor(e, t) {
            (this.configuration = { expires: null, path: "/", domain: window.location.hostname }), (this.name = e), (this.value = t);
        }
        write() {
    ...
    class TargetReferrer {
        constructor(e) {
            if (((this.el = e), (this.locationPath = location.href), !this.el.hasAttribute(selectors$N.dataTargetReferrer))) return !1;
            this.init();
        }
        init() {
    ...
    class LargePopup {
        ...
        init() {
            (!1 !== this.cookie.read() && !window.Shopify.designMode) ||
                (window.Shopify.designMode || new DelayShow(this.popup, this.modal), this.form && this.form.classList.contains(classes$o.success) && this.checkForSuccess(), this.initClosers());
        }
        checkForSuccess() {
            fadeIn(this.modal), this.cookie.write();
        }
        initClosers() {
    ...
    class Tracking {
        ...
        clickEvents() {
            this.close.addEventListener("click", (e) => {
                e.preventDefault(), window.Shopify.customerPrivacy.setTrackingConsent(!1, () => fadeOut(this.modal)), document.documentElement.style.setProperty("--cookie-bar-height", "0px");
            }),
    ...
    class NewsletterPopup {
        ...
        init() {
            (!1 !== this.cookie.read() && !window.Shopify.designMode) || (this.show(), this.form.classList.contains(classes$o.success) && this.checkForSuccess());
        }
        show() {
        ...
        showForm() {
            this.heading.addEventListener("click", (e) => {
                e.preventDefault(), this.heading.classList.add(classes$o.hide), this.newsletterField.focus();
            });
        }
        closePopup() {
            this.close.addEventListener("click", (e) => {
            ...
            sections$n[this.id].forEach((t) => {
                if ("function" == typeof t.onBlockSelect) {
                    ...
                    Array.prototype.filter
                        .call(e.target.parentNode.children, (t) => t !== e.target)
                        .forEach((e) => {
                            fadeOut(e);
                        });
                }
        ...
        onBlockDeselect(e) {
            sections$n[this.id].forEach((t) => {
                "function" == typeof t.onBlockDeselect &&
                    Array.prototype.forEach.call(e.target.parentNode.children, (e) => {
                        fadeIn(e);
                    });
            });
        },
    ...
    class Password {
        ...
        init() {
            this.loginToggle.addEventListener("click", (e) => {
                e.preventDefault(), slideDown(this.login), hideElement(this.signup), this.errors && hideElement(this.errors);
            }),
                this.newsletterToggle.addEventListener("click", (e) => {
                    e.preventDefault(), hideElement(this.login), slideDown(this.signup), this.errors && hideElement(this.errors);
                }),
                this.contactErrors && (hideElement(this.login), slideDown(this.signup)),
                this.loginErrors && (slideDown(this.login), hideElement(this.signup));
        }
    }
    ...
    register("password-template", passwordSection),
        ...
        document.addEventListener("DOMContentLoaded", function () {
            load("*");
            "true" === document.body.getAttribute("data-animations") && AOS.init({ once: !0, offset: 0 });
  ...
  function buildCartDrawerFunction(response){
   var total_saving_cstm = 0; 
  $.each(response.items, function(index, cartItem) {
  ...
  setTimeout(function(){
    $('.saving_price').text('₹ '+total_saving_cstm);
    $('.item__save span').text('₹ '+total_saving_cstm);
      }, 1000); 
  
  if(response.total_price > 0){
  $('.cart-dropdown__top').removeClass('is-hidden');
    $('[data-items-holder]').removeClass('is-hidden');
  $('.header__cart__status').removeClass('is-hidden'); 
    $('[data-empty-message]').addClass('is-hidden');
    $('[data-foot-holder]').show();
  $('.may_you__collection').removeClass('hide__drawer_collection');  
  $('.cart__popup_count').text(response.item_count+' Item'); 
  $('.cart_popup_price').text(themeCurrency.formatMoney(response.total_price, theme.moneyFormat));
    if(!$('#cart-dropdown').hasClass('is-open')){
      $('.cart__popup_main').show();
      setTimeout(function(){
      hidecartpopup();
      }, 5000);
    }
    ...
    $('.cart-dropdown__top').addClass('is-hidden');
    $('.may_you__collection').addClass('hide__drawer_collection');  
  } 
    setTimeout(function(){
      $('[data-quick-add-holder] .caps').removeClass('is-added');
    }, 2000);
}
function addGwbProductCart(result) {
  var _totalPrice = result.total_price;
  var _totalItem = result.item_count;
  console.log(_totalPrice);
  if(_totalPrice > 0){
    if(_totalPrice < 150000){
        $.ajax({
         type: 'POST',
         url: '/cart/update.js', 
         data: {
    ...
    $.ajax({
     ...
     data: {
       updates:{
          "43324853485805":0, // Use the line-item key inside the quotes 
          "43324857975021":0
       }
     },
     dataType: 'json',
    ...
    fetch("/cart?section_id=api-cart-items");
    $('.cart-dropdown__top').addClass('is-hidden');
    $('[data-items-holder]').addClass('is-hidden');
    $('[data-foot-holder]').hide();
    $('.header__cart__status').addClass('is-hidden');
      setTimeout(function(){
    $('[data-empty-message]').removeClass('is-hidden');
      }, 2000);
  } 
  setTimeout(function(){
  $.getJSON('/cart', function(cart) {
    $('.item__counts span').text(cart.item_count);
  });
 }, 900);

  setTimeout(function(){
$.getJSON('/cart.json', function(cartJSON){
...
$.getJSON('/cart.json', function(cartJSON){
if(cartJSON.total_price <= 0 && cartJSON.item_count == 1){
  $.ajax({
   type: 'POST',
   url: '/cart/clear.js',
   dataType: 'json',
